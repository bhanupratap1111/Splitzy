...
export const TESTIMONIALS = [
    {
      quote:
        "Splitzy made splitting bills with friends feel like a breeze—no more awkward money talks!",
      name: "Ananya Sharma",
    ...
    {
      quote:
        "Honestly, I trust Splitzy's math more than my own! It's the ultimate hack for group trips.",
      name: "Ritik Mehra",
    ...
    {
      quote:
        "Now that I use Splitzy, I actually look forward to settling expenses. It's just too smooth!",
      name: "Meera Nair",
